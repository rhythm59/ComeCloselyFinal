...
class FollowingProfile extends React.Component<ComponentProps, ComponentState> {
              ...
              {!getUserLoading && (
                <Fragment>
                  <View style={styles.userMainView}>
                    <Text style={styles.nameText}>Leanne Graham</Text>
                  ...
                  <View style={styles.followersFollowingView}>
                      ...
                      <View style={styles.followingView}>
                        ...
                        <View style={styles.followingTextView}>
                          <Text style={styles.followingCountText}>0</Text>
                        </View>
                      </View>
                      ...
                      <View style={styles.followersView}>
                        ...
                        <View style={styles.followersTextView}>
                          <Text style={styles.followersCountText}>0</Text>
                        </View>
                      </View>
                  </View>
...
FollowingProfile.contextType = AuthContext;
...
export default connect(mapStateToProps, mapDispatchToProps)(FollowingProfile);
